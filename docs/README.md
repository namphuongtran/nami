...
| Section | Contents |
|---|---|
| [`architecture/`](architecture/) | Software Architecture Document (SAD): an arc42-flavored, ISO/IEC/IEEE 42010-conformant description built from the ADRs, with C4 context/container/component views, runtime and data views, quality and operational views, and supporting views |
...
| [`GLOSSARY.md`](GLOSSARY.md) | Domain, protocol, and project-convention vocabulary used across all three layers; definitions that point at the document of record rather than restating it |
