...
| Admin and login UI | Server-rendered Razor, but two distinct technologies: **MVC Razor** for the admin BFF (token off the browser), and **Razor Pages** for the login, consent, and logout surface, which no ADR yet owns | 0020 |
