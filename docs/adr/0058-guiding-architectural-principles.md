...
* Related decisions: ADR-0024 (the hexagonal shell plus vertical slices that apply these principles structurally), ADR-0020 (bounded contexts, the `Proposal` aggregate, and the edge-only eventing / no-EDA-backbone rule), ADR-0021 (seam isolation), ADR-0047 (the swappable `ICheckAccess` port), ADR-0029 (the BFF composition-boundary exception), and the infrastructure-port ADRs (ADR-0001/0006/0008/0009).
