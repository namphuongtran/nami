...
consulted: ASP.NET Core 10 resilience / rate-limiting middleware and Polly `AddStandardResilienceHandler` docs; evidence in the design corpus's NFR, performance and resiliency document
