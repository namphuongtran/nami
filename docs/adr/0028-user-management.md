...
* Security/DPO follow-ups: the passkey attestation policy and PII profile retention.
...
* Original decision 2026-07-04 (the shape accepted, with build-time picks still open); the self-service decision to avoid `MapIdentityApi` was made 2026-07-13.
