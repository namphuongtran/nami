...
* Standards verified 2026-07-18 and all three final-specification dates **re-verified at openid.net on 2026-07-25**: OID4VP 2025-07-10 (a 60-day review to 2025-06-23, a vote to 2025-07-01, published 2025-07-10), OID4VCI 2025-09-16, and HAIP 2025-12-29; plus SD-JWT VC and ISO mdoc/mDL formats and eIDAS 2.0 / EUDI Wallet; OpenIddict has no native OID4VC support. All named factually. The re-verification was deliberate: the sibling ADR-0068 had recorded an OpenID Foundation press-release date in place of the approval date, so this ADR's dates were the most likely place for the same class of error, and they held.
