...
collector-outage test, and the chaos suite ([14 observability](14-observability-capacity-slo.md));
the CI job graph, the release pipeline, and the deployment tests
([15 CI/CD and deployment](15-cicd-and-deployment.md)); the migration and expand/contract
CI checks ([13 tenant lifecycle](13-tenant-lifecycle.md)); the foundational CI-gate set
...
| Load and soak | The NFR targets on p95/p99; the SLO CI gate and canary | k6 / NBomber | ADR-0041 (owned by [14](14-observability-capacity-slo.md)) |
...
| Area | Owner doc |
|---|---|
| Cross-tenant / RLS isolation | [02](02-data.md), [05](05-authorization.md), [04](04-core-protocol.md), [13](13-tenant-lifecycle.md) |
| PKCE, discovery, per-tenant issuer, claims | [04](04-core-protocol.md) |
| mTLS spoofed-header rejection, DPoP, device backoff, PAR flood | [04](04-core-protocol.md), [11](11-advanced-flows.md) |
| Revocation propagation, distrusted-kid, config propagation | [10](10-revocation-caching.md) |
| Dual-control (proposer not approver, step-up, target_changed, BOLA) | [12](12-admin-api.md), [05](05-authorization.md) |
| Audit hash-chain integrity, delivery, two-lane independence | [03](03-audit.md) |
| Playwright admin end-to-end (propose, second-user step-up approve, no token in browser) | [12 app](12-admin-app.md) |
| Erasure erase-set plus chain-verify gate | [13 erasure](13-erasure-and-data-subject-rights.md) |
| Federation security (SSRF egress, RFC 9207 iss/mix-up, anti-takeover, claim allow-list, HIBP fail-open) | [06](06-user-management.md) |
| Abuse defense (risk-triggered challenge, lockout-DoS scoping) | [08](08-login-consent-ui.md) |
| Load/SLO gate, external canary, collector-outage, chaos | [14](14-observability-capacity-slo.md) |
...
green in CI (with the load/SLO gate and canary as [14](14-observability-capacity-slo.md)'s
...
- Design docs: [15 CI/CD and deployment](15-cicd-and-deployment.md) (the pipeline that runs these suites), [14 observability](14-observability-capacity-slo.md) (load/SLO gate, canary, chaos), [13 tenant lifecycle](13-tenant-lifecycle.md) (migration CI checks), [01 foundations](01-foundations.md) (the foundational CI gates), and the feature docs cited in the acceptance-test catalog.
- [Architecture](../architecture/README.md); [Pre-GA ratification checklist](../PRE-GA-RATIFICATION-CHECKLIST.md).

---

Previous: [14 Observability, capacity, and SLO](14-observability-capacity-slo.md) · Next: [15 CI/CD and deployment](15-cicd-and-deployment.md)
