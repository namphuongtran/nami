...
erDiagram
    ...
    DUAL_CONTROL_PROPOSALS {
        ...
        text TargetClass "mutate, create or query: which guard applies, ADR-0081"
        text TargetETag "nullable; the xmin-derived ETag, required only for TargetClass mutate"
